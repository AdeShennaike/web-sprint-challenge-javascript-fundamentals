...
// It has access to everything within the parent function.
...
const zooAnimals = [
  ...
  */
  ...
  function USApop(array){
    return array.reduce((popul, item) => popul + item.population,0)
  }
...
*/
function CuboidMaker(cuby){
  this.length = cuby.length;
  this.width = cuby.width;
  this.height = cuby.height;
}
